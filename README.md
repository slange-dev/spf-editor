...
# SPF/SE 4.5
For nostalgica there is a SPF/SE 4.5 available. See the [binaries](binaries) directory.

To make the SPF/SE 4.5 release a full working release, you need a serial number.
As we've got the permission to distribute SPF/SE for free, we can also make a valid serial number available.
You can use the serial number **30101185** (yes, the serial number for version 3.5 works with 4.5, too).
...
| Profile       | File type                                                                                                                                                                                                                                                                                                                |
| ------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| AFP           | AFP (MO:DCA) files. Each record begins with a X'5A' followed by the length of the record                                                                                                                                                                                                                                 |
...
| VR            | Files with a variable record length. Each record begins with a zero byte followed by a three-byte record length field (length of the record field **not** included). Format under IBM z/OS for files in USS that can be processed record by record from z/OS if the JCL specifies "FILEDATA=RECORD" on the DD statement. |
| VRA           | Same as VR (VR with ASA control characters)                                                                                                                                                                                                                                                                              |
| VRM           | Same as VR (VR with IBM control characters)                                                                                                                                                                                                                                                                              |
